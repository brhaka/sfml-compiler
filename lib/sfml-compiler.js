( function() {
  ...
  module.exports = SfmlCompiler = {
    ...
    toggle: function() {
      var args, command, deleteDatBatM8, dllFiles, doLog, editor, exit, file, fs, hideCMD, options, path, pathToCurrentFile, pathToCurrentWorkingDir, resourceFiles, someStuff, stderr, stdout;
      ...
      require("child_process").exec("cmd /c \"" + pathToCurrentWorkingDir + "\\compiler.bat\"");
      // new BufferedProcess({
      //   command: command,
      //   args: args,
      //   options: options,
      ...
      return setTimeout(function() {
        return fs.exists(pathToCurrentWorkingDir + "\\compiling_error.txt", function(exists) {
          var log;
